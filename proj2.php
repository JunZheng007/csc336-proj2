...
?>
	...
	<form action="<?php echo basename($_SERVER['PHP_SELF']); ?>" method="get">
		...
		<tr><td>&nbsp;</td><td><input type="submit" value="Add Producter"></td></tr>
	    </table>
	</form>
	...
	<form action="<?php echo basename($_SERVER['PHP_SELF']); ?>" method="get">
		...
		<tr><td>Supplied by</td><td> <input type="text" size="30" name="supplier"></td></tr>
		<tr><td>Produced by</td><td> <input type="text" size="30" name="producer"></td></tr>
	...
	<form action="<?php echo basename($_SERVER['PHP_SELF']); ?>" method="get">
	    <table border="0" cellpadding="0" cellspacing="0">
		<tr><td>Name</td><td><input type="text" size="30" name="customer"></td>
		    <td align="center">VIP</td><td><input type="checkbox" name="vip" value="VIP"></td></tr>
		<tr><td>SSN</td><td> <input type="text" size="30" name="SSN"></td>
		    <td>Staring Date</td><td> <input type="text" size="30" name="start"></td></tr>
		<tr><td>telephone#</td><td> <input type="text" size="30" name="telephone"></td>
		    <td align="center">Discount</td><td> <input type="text" size="30" name="discount"></td></tr>
		<tr><td>CD title</td><td> <input type="text" size="30" name="CD"></td></tr>
		<tr><td>&nbsp;</td><td><input type="submit" value="Borrow the CD"></td></tr>
	    </table>
	</form>
	...
	<form action="<?php echo basename($_SERVER['PHP_SELF']); ?>" method="get">
	    <table border="0" cellpadding="0" cellspacing="0">
		<tr><td>CD Title</td><td><input type="text" size="30" name="find"></td>
...
?>
	...
	<form action="<?php echo basename($_SERVER['PHP_SELF']); ?>" method="get">
	    <table border="0" cellpadding="0" cellspacing="0">
		<tr><td>CD Artist</td><td><input type="text" size="30" name="find_artist"></td>
		<tr><td>CD Year</td><td><input type="text" size="30" name="find_year"></td>
			<td><input type="submit" value="Find"></td></tr>
	    </table>
	</form>
<?php
